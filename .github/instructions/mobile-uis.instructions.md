...
- `mobile/lib/uis/pages/**` — `mobile-pages.instructions.md`: page, route lifecycle, and page view model guidance
- `mobile/lib/uis/core/**` — `mobile-uis-core.instructions.md`: shared/transversal UI widget and visual primitive guidance
