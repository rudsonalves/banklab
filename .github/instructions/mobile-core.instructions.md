---
description: "Use when creating or editing core infrastructure files: dependency injection, routing, Result/AppError/Command, RestClient, HTTP interceptors, secure storage, AppEnv, extensions. Covers cross-cutting concerns for the mobile Flutter app."
applyTo: "mobile/lib/core/**"
---
...
- register it in `services/core_services.dart` when it is a cross-cutting service
