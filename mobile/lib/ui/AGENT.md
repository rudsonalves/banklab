...
- feature-local presentation models under `ui/pages/<feature>/.../models`
...
Use `ui/pages/<feature>/.../models` for UI-flow types that do not belong to
...
- Put app-wide theme changes in `ui/components/themes` or `app_widget.dart` when the
